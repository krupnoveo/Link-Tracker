...
public class Keys {
    ...
    public static final ForeignKey<ChatToLinkRecord, ChatRecord> CONSTRAINT_5 = Internal.createForeignKey(ChatToLink.CHAT_TO_LINK, DSL.name("CONSTRAINT_5"), new TableField[] { ChatToLink.CHAT_TO_LINK.CHAT_ID }, Keys.CONSTRAINT_1, new TableField[] { Chat.CHAT.CHAT_ID }, true);
